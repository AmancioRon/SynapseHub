...
import { User, Customer, Activity, Expense, Appointment, HealthEntry, Notification, WorkoutDay, HealthProfile } from '../types';
...
export const StoreProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <StoreContext.Provider value={{
      user, customers, activities, expenses, appointments, healthEntries, workoutPlan, notifications, expenseCategories,
